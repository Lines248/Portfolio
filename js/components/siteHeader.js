export function SiteHeader() {
    ...
    <nav class="nav" role="navigation" aria-label="Main navigation">
        ...
        <ul class="nav__links" role="list">
            ...
            <li><a href="/assets/resume.pdf" class="nav__resume" target="_blank" rel="noopener noreferrer" download="Resume-Caroline-Sultzer.pdf" data-tooltip="Click to download PDF" aria-label="Download Caroline Sultzer's resume (PDF, opens in new tab)">RESUME</a></li>
        </ul>
    ...
    <div id="nav-dropdown" class="nav-dropdown" role="navigation" aria-label="Main menu" hidden>
        ...
        <a href="/assets/resume.pdf" class="nav__resume" target="_blank" rel="noopener noreferrer" download="Resume-Caroline-Sultzer.pdf" data-tooltip="Click to download PDF" aria-label="Download Caroline Sultzer's resume (PDF, opens in new tab)">RESUME</a>
    </div>
    `;
}